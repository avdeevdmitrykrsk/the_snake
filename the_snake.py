...
Изменена палитра цветов, размеры экрана, добавлен новый класс _class WrongApple,
который добавляет на игровое поле Неправильное/гнилое яблоко, если
подобрать которое, длина змейки уменьшится на 1.
